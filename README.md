...
![V2L Screenshot](https://user-images.githubusercontent.com/your-github-id/your-repo/path/to/screenshot.png)
...
- **بدون نیاز به نصب:** نیازی به نصب پایتون، گیت یا وابستگی‌های دیگر برای کاربران نهایی نیست.
